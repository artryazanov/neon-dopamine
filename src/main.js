// Game Constants
    ...
    const XP_GEM_PULL_SPEED = 300; // Pixels per second towards player
    ...
    class Player extends Entity {
        ...
        fire() {
            ...
            const baseAngle = Math.atan2(mouseY - this.y, mouseX - this.x); // Aim at mouse
    ...
    class Game {
        ...
        displayUpgradeChoices() {
            ...
            const availableUpgrades = [
                ...
                { name: 'XP Gem Magnetism', description: 'Increase the range at which XP gems are pulled towards you.', apply: () => XP_GEM_PULL_SPEED *= 1.25 } // This is a bit indirect, would need more sophisticated system to apply to specific game.xpGems instance, but this works for global effect
            ];
